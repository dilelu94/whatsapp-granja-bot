...
describe('google.js module', () => {
    ...
    test('getTodayEvents should query google calendar api with correct bounds', async () => {
        ...
        const events = await google.getTodayEvents('test-calendar@gmail.com');
    ...
    test('createEvent should insert event to calendar api', async () => {
        ...
        const created = await google.createEvent('Dentist', startTime, endTime, 'test-calendar@gmail.com');
    ...
    test('syncCalendarMessages should parse [WA] events and schedule messages', async () => {
        ...
        const { results } = await google.syncCalendarMessages(mockWhatsAppClient, 'test-calendar@gmail.com', TEST_DB_PATH);
